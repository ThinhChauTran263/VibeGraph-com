# Structural accuracy - spring-petclinic (main, F2)

Generated: 2026-07-01 22:11  |  Project id: `1a03781f`  |  Source files (main): 30
...
|---|---:|---:|---:|
| Types (class+iface+enum+record) | 25 | 25 | 100 |
| - Class (incl. DBModel) | 22 | 22 | 100 |
| - Interface | 3 | 3 | 100 |
| - Enum | 0 | 0 | n/a |
| Entities (Entity to DBModel) | 6 | 6 | 100 |
| REST/MVC endpoints | 16 | 17 | 94.1 |
| Methods | 86 | (not counted in P1) | n/a |

Context: Controller annotations in source = 6; RequestMapping occurrences = 1.

## Edges (tool distribution)

| Edge type | Count |
|---|---:|
| CALLS (method-call resolution) | 64 |
| HAS_METHOD | 92 |
| HANDLES_ROUTE | 16 |
| INJECTS | 6 |
...
In source but NOT in tool graph (0): 
