...
public final class NodeLayerClassifier {
    ...
    public static List<NodeData> withLayers(List<NodeData> nodes) {
        ...
        for (NodeData node : nodes) {
            String layer = layerOf(node, byFullName, layerCache);
    ...
    private static String layerOf(NodeData node, Map<String, NodeData> byFullName, Map<String, String> cache) {
        if (node == null) {
            return OTHER;
        }
        ...
        String inherited = inheritedLayer(node, byFullName, cache);
        if (inherited != null) {
    ...
    private static String explicitLayer(NodeData node) {
        ...
        return switch (value) {
            ...
            case "ENTITY" -> DATA_ACCESS;
            case "CONFIG", "COMPONENT" -> OTHER;
            default -> null;
        };
    }

    private static String inheritedLayer(NodeData node, Map<String, NodeData> byFullName, Map<String, String> cache) {
        ...
        return layerOf(ownerNode, byFullName, cache);
    }
