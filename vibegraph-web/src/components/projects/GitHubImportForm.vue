...
<template>
  <section class="github-import" :class="{ 'github-import--embedded': embedded }" aria-labelledby="github-import-heading">
...
.github-import__btn--primary:not(:disabled):hover {
  ...
  box-shadow: 0 0 0 1px rgba(167, 139, 250, 0.5), 0 18px 40px -14px rgba(124, 58, 237, 0.8);
}
